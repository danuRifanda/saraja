...
<form action="saveOrang.php" method="POST" class="container" >
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="noKartu2" placeholder="No Kartu" value="<?php if ($act == 'edit') echo $row->uid; ?>"
            readonly>
            <input type="hidden" name="noKartu" value="<?php if ($act == 'edit') echo $row->uid; ?>">
    </div>
    <!-- <div id="nokartu"> </div> -->
    <div class="mb-3">
